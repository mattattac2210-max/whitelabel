...
export type ReportType = 'expense_report' | 'logbook_report' | 'deduction_estimate' | 'trip_log' | 'session_summary';
export type LogbookStatus = 'active' | 'completed' | 'expired' | 'cancelled' | 'archived';
